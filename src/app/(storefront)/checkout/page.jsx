            ...
            <section className="bg-white rounded-2xl border border-border p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input id="address" name="address" type="text" required autoComplete="shipping street-address" value={form.address} onChange={update('address')} placeholder="12 Solar Avenue, GRA" className="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-green/20 focus:border-slate-green transition-colors" />
                </div>
                <div>
                  <label htmlFor="city" className="block text-sm font-medium text-slate-green mb-1.5">City *</label>
                  <input id="city" name="city" type="text" required autoComplete="shipping address-level2" value={form.city} onChange={update('city')} placeholder="Lagos" className="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-green/20 focus:border-slate-green transition-colors" />
                </div>
                <div>
                  <label htmlFor="state" className="block text-sm font-medium text-slate-green mb-1.5">State *</label>
                  <input id="state" name="state" type="text" required autoComplete="shipping address-level1" value={form.state} onChange={update('state')} placeholder="Lagos State" className="w-full px-4 py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-green/20 focus:border-slate-green transition-colors" />
                </div>
                <div className="sm:col-span-2">
